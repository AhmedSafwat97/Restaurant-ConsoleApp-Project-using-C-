...
namespace Restaurant_ConsoleApp__Project_using_C_
{
    internal class Sign : User
    {
        ...
        // ______________________________________
        // For Sign In Logic
        //void LoginWithEmailAndPassword(User user)
        //{
        //    Console.WriteLine("Enter Your Email:");
        //    user.Email = Console.ReadLine();
        ...
        //    while (!validInput)
        //    {
        //        Console.WriteLine("You Want To Sign In As ((1)Customer Or (2)Worker) ?:");
        //        int userType;
        //        bool isNumeric = int.TryParse(Console.ReadLine(), out userType);
        ...
        //                                case 1:
        //                                    Waiter Waiter1 = new Waiter();
        //                                    LoginWithEmailAndPassword(Waiter1);
        //                                    SaveUserData(Waiter1, "Waiter.json");
        //                                    Console.WriteLine("You are signed up now as a waiter");
        //                                    validWorkerType = true;
        //                                    break;
        ...
        //                                case 2:
        //                                    Chef Chef1 = new Chef();
        //                                    LoginWithEmailAndPassword(Chef1);
        //                                    SaveUserData(Chef1, "Chef.json");
        //                                    Console.WriteLine("You are signed up now as a chef");
        //                                    validWorkerType = true;
        //                                    break;
        ...
        //        else
        //        {
        //            Console.WriteLine("Invalid choice. Please enter a valid number (1, 2 ).");
        //        }
        //    }
        //}


        //public void CheckEmailAndPassword<T>(T userData, string fileName) where T : User
        //{
